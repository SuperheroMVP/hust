...
<div class="main-content">
    ...
    <section class="inner-header divider parallax layer-overlay overlay-dark-5" style="background-image: url(assets/images/bg3.jpg); background-position: 50% 97px;">
                    ...
                    <div class="col-md-6">
                        <div class="video-popup">
                            <a href="https://www.youtube.com/watch?v=pW1uVUg5wXM" data-lightbox-gallery="youtube-video" title="Video">
                                <img alt="" src="assets/images/5.jpg" class="img-responsive img-fullwidth">
                            </a>
                        </div>
                    </div>
                </div>
    ...
    <!-- Divider: Funfact -->
    <section class="divider parallax layer-overlay overlay-theme-colored-9" data-bg-img="images/bg/bg2.jpg" data-parallax-ratio="0.7" style="background-image: url(&quot;images/bg/bg2.jpg&quot;); background-position: 50% 615px;">
        <div class="container">
            <div class="row">
